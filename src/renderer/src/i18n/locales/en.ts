...
const HomePage = {
  ...
  'Welcome to Bedrock Engineer': 'Welcome to {{appName}}',
...
const SettingPage = {
  ...
  'Complete permissions for all Bedrock Engineer features including translation and video generation':
    'Complete permissions for all {{appName}} features including translation and video generation',
...
const TodoModal = {
  ...
  'Hide chat history': 'Hide chat history',
