export const bedrockSettings = {
  ...
  ja: {
    ...
    // Visible Models
    'Visible Models': '表示するモデル',
    'Select which models appear in the chat model selector. Leave empty to show all models.':
      'チャットのモデル選択に表示するモデルを選択します。空の場合はすべてのモデルが表示されます。',
    'Add a visible model': '表示するモデルを追加',
    // Application Inference Profiles
