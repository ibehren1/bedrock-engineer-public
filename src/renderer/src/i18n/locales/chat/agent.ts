...
- Guidance based on best practices`,
    ...
    agentYamlDownloaded: 'Agent YAML saved to {{path}}',
    failedToDownloadYaml: 'Failed to download the agent YAML',
    deleteSharedFile: 'Delete Shared File',
    sharedFileDeleted: 'Shared file deleted. Your own copy of the agent is unchanged.',
    failedToDeleteSharedFile: 'Failed to delete the shared file',
    importAgent: 'Import Agent',
    agentImported: 'Imported "{{name}}". You can edit it like any of your own agents.',
    failedToImportAgent: 'Failed to import the agent file',
...
- ベストプラクティスに基づいたガイダンス`,
    ...
    agentYamlDownloaded: 'エージェントの YAML を {{path}} に保存しました',
    failedToDownloadYaml: 'エージェントの YAML をダウンロードできませんでした',
    deleteSharedFile: '共有ファイルを削除',
    sharedFileDeleted: '共有ファイルを削除しました。ご自身のエージェントはそのまま残ります。',
    failedToDeleteSharedFile: '共有ファイルを削除できませんでした',
    importAgent: 'エージェントをインポート',
    agentImported:
      '「{{name}}」をインポートしました。ご自身のエージェントと同じように編集できます。',
    failedToImportAgent: 'エージェントファイルをインポートできませんでした',
