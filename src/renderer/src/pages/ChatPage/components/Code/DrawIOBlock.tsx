  ...
  return (
    <div className={`my-4 border border-strong rounded-container overflow-hidden ${className}`}>
      ...
      <div className="flex items-center justify-between bg-raised px-2.5 py-1 border-b border-strong">
        <span className="text-sm font-medium text-ink">DrawIO</span>
      ...
      <ResizableContainer initialHeight={600} minHeight={200} maxHeight={800}>
        ...
        <div
          className={`h-full bg-surface overflow-hidden border-0 ${
        ...
        <div
          className={`max-w-[88vw] h-full overflow-y-scroll bg-surface-2 ${isPreviewMode ? 'hidden' : 'block'}`}
        >
          <SyntaxHighlighter
            language="xml"
            style={tomorrow}
