    ...
    // Help Menu
    {
      ...
      submenu: [
        ...
        { type: 'separator' },
        {
          ...
          click: async () => {
            await shell.openExternal('https://github.com/ibehren1/bedrock-engineer-public')
          }
        }
      ]
    }
...
async function createWindow(): Promise<void> {
  ...
  // Keep the window title as the app name (package.json productName) rather than
  // letting the renderer's empty <title> reset it.
